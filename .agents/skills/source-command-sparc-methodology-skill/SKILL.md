---
name: "source-command-sparc-methodology-skill"
...
# source-command-sparc-methodology-skill

Use this skill when the user asks to run the migrated source command `sparc-methodology-SKILL`.

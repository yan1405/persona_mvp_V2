---
name: "source-command-hooks-automation-skill"
...
# source-command-hooks-automation-skill

Use this skill when the user asks to run the migrated source command `hooks-automation-SKILL`.

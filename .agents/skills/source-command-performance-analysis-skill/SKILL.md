---
name: "source-command-performance-analysis-skill"
...
# source-command-performance-analysis-skill

Use this skill when the user asks to run the migrated source command `performance-analysis-SKILL`.

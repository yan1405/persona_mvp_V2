---
name: "source-command-swarm-orchestration-skill"
...
# source-command-swarm-orchestration-skill

Use this skill when the user asks to run the migrated source command `swarm-orchestration-SKILL`.

---
name: "source-command-agent-researcher-skill"
description: "Agent skill for researcher - invoke with $agent-researcher"
---

# source-command-agent-researcher-skill

Use this skill when the user asks to run the migrated source command `agent-researcher-SKILL`.
